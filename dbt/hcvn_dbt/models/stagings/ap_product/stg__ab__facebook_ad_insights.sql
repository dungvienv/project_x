...
select 
    ...
    json_value("_AIRBYTE_DATA",'$."catalog_segment_value_mobile_purchase_roas"') as catalog_segment_value_mobile_purchase_roas,
    ...
    json_value("_AIRBYTE_DATA",'$."inline_link_clicks"') as inline_link_clicks,
    json_value("_AIRBYTE_DATA",'$."inline_post_engagement"') as inline_post_engagement,
    json_value("_AIRBYTE_DATA",'$."objective"') as objective,
    json_value("_AIRBYTE_DATA",'$."optimization_goal"') as optimization_goal,
    json_value("_AIRBYTE_DATA",'$."outbound_clicks"') as outbound_clicks,
    ...
    json_value("_AIRBYTE_DATA",'$."unique_inline_link_clicks"') as unique_inline_link_clicks,
